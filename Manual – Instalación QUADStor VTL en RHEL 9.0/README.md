# Manual – Instalación QUADStor VTL en RHEL 9.0
...
```bash
subscription-manager register --username mauriciomejiae --password Colombia.2023 --force
...
Para más detalles: https://quadstor.com/vtlsupport/145-installation-on-rhel-centos-sles-debian.html
